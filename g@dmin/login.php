                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 p-4" id="wardenLogin" method="post" action="warden-login.php">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="bi bi-key-fill"></i></span>
                        <input type="password" class="form-control stop-focus" placeholder="password" name="warden_password" id="warden-password">
                      </div>
                    </div>
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 p-4" id="adswLogin" method="post" action="adsw-login.php">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="bi bi-key-fill"></i></span>
                        <input type="password" class="form-control stop-focus" placeholder="password" name="adsw_password" id="adsw-password">
                      </div>
                    </div>
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 p-4" id="dswLogin" method="POST" action='dsw-login.php'>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="bi bi-key-fill"></i></span>
                        <input type="password" class="form-control stop-focus" placeholder="password" name="dsw_password" id="dsw-password">
                      </div>
                    </div>
